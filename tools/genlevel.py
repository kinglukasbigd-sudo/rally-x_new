#!/usr/bin/env python3
"""Offline level generator for Dakar X (clean-room reconstruction).
...
forming a heavily looped playfield (the mazes are loops, not perfect
...
def generate(seed, name, rtype, difficulty, fuel, drain, pspeed, espeed,
    ...
    with open(path, 'w') as f:
        f.write("# Dakar X level data -- generated by tools/genlevel.py\n")
